            ...
            <form method="post" enctype="multipart/form-data" action="/NetCommerce/index.php/reg">
                ...
                <div class="form">
                    <div>
                        ...
                        <input type="text" id="BI" name="BI" placeholder="Nº do BI" />
                    ...
                    <div>
                        ...
                        <input type="number" id="Telefone" name="Telefone" placeholder="Ex. 924 377 250" />
                        <label for="Email">Email</label>
                        <input type="email" id="Email" name="Email" placeholder="meuemail@gmail.com" />

                        <label for="Morada">Morada</label>
                        <input type="text" id="Morada" name="Morada" placeholder="Minha Morada" />
                ...
                <div class="form">
                    <div>
                        ...
                        <input type="text" id="Titular" name="Titular" placeholder="Nome do Titular" />
                    ...
                    <div>
                        ...
                        <input type="file" id="Doc_BI" name="Doc_BI" />
                        <label for="Doc_Conta">Documento de dados da Conta</label>
                        <input type="file" id="Doc_Conta" name="Doc_Conta" />
                ...
                <div class="form">
                    <div>
                        ...
                        <video controls>
                            <source src="./Video/Cypher_Afro_dance.mp4" type="video/mp4">
                        </video>
